...
интервал от 50 до 100 и сообщить результат на экран в следующем виде: «Число а не содержится в интервале.» или «Число а содержится в интервале.«, где а — аргумент метода.
